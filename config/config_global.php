...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'MnyJ_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '4344b3oiQKMHYAmW';
...
// ---------------------------  CONFIG 插件开发  --------------------------- //
$_config['plugindeveloper'] = 1;    //开启插件模式
// -------------------  THE END  -------------------- //
