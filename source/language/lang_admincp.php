...
(
	...
	'home_security_service_close_info' => '<li>推荐您开通云平台, 开通后，当站点程序出现严重安全漏洞需要立即进行修补的时候，我们会通过QQ及时通知给您<br/><a href="?action=cloud&operation=open">点击<strong>"云平台->开通Discuz!云平台"</strong>开通此功能</a></li>',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'usergroups_edit_basic_forcesecques_comment' => '选择“是”则此用户组的用户在登录后台前必须设置安全提问后才可登陆后台, config中为全局开关',
